...
@section('tab_content')
<div class="tab-pane fade show tabela" id="v-pills-vendas" role="tabpanel" aria-labelledby="v-pills-vendas-tab">
    <div class="conteudo-aba">
            ...
            <nav class="navbar navbar-light bg-light">
                        ...
                        <li class="nav-item cadastro">
                            <button  type="button" class="btn bg-success nav-link" data-bs-toggle="modal"
                             @if(count($buyers) == 0)
                                data-bs-target="#nocustomer"
                            @elseif(count($products) == 0) 
                                data-bs-target="#noproducts"
                             @else 
                                data-bs-target="#vendasCadastro" 
                             @endif 
                    ...
                    <div class="collapse" id="collapseExample">
                            ...
                            @include('search.pesquisa-vendas')
                        
                    </div>

                  
                        <div class="tab-pane fade show active" id="pills-sellings" role="tabpanel" aria-labelledby="pills-sellings-tab">
                          @include('tables/tabela-vendas')
                        </div>
            ...
            @include('alerts.nocustomer')
            @include('alerts.noproducts')
            @include('alerts.buy-situations')
            @include('create.cadastro-vendas')
            @include('update.edita-venda')
            @include('delete.deletar-venda')
            </div>
</div>
