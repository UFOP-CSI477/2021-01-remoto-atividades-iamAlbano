<!-- Modal Cadastro de vendas -->
<div class="modal fade" id="vendasCadastro" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <ul class="nav abas-cadastro nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-venda-tab" data-bs-toggle="pill" data-bs-target="#pills-venda" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                ...
                <hr id="divider">
              <form class="row g-3 text-start" method="POST" action="/vendas">
                @csrf
                <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-venda" role="tabpanel" aria-labelledby="pills-venda-tab">
                        ...
                        <div class="modal-footer">
                            ...
                            @if(count($buyers) == 0)disabled @endif>Cadastrar</button>
                        </div>
             </form>
            </div>
        </div>
...
var total = 0;
    ...
    `<tr id="new-buy-product-`+count+ `">
        <td><input type="text" class="form-control" list="products-list" id="produto-`+count+`" name="input[nome][]" onchange="calc_value()" required>
        </td>
