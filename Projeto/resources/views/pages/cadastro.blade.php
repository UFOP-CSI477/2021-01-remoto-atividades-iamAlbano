...
<div class="login position-absolute top-50 start-50 translate-middle shadow p-3 mb-5">
    ...
    <h1 class="text-center">Seja bem-vindo, @php echo$user@endphp!</h1>
    <h2 class="text-center">Crie uma senha para acessar o sistema.</h2>
    <hr id="divider">
    <form action="" class="login-input">
        ...
        <div class="input-group mb-3">
            ...
            <input type="passwordConfirm" class="form-control" placeholder="Confirmar senha" aria-label="passwordConfirm" aria-describedby="basic-addon1" required>
        </div>
